...
Please check the Github page for more information about this release."""
            ...
            self.description = wx.StaticText(panel, label=f"{self.constants.patcher_name} {version} is now available - You have {self.constants.patcher_version_label}. Would you like to update?")
        ...
        if utilities.check_seal() is True:
            ...
            if patches:
                ...
                if network_handler.NetworkUtilities("https://api.github.com/repos/albert-mueller/OpenCore-Legacy-Patcher-T2/releases/latest").verify_network_connection() is False:
                    warning_str = f"""\n\nWARNING: We're unable to verify whether there are any new releases of {self.constants.patcher_name} on Github. Be aware that you may be using an outdated version for this OS. If you're unsure, verify on Github that {self.constants.patcher_full_name} is the latest official release"""
