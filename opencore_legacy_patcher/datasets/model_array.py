...
DualGPUPatch = [
    ...
    "MacBookPro8,2",
    "MacBookPro8,3",
    # T2 MacBook Pro with switchable GPUs (Intel iGPU + AMD dGPU)
    "MacBookPro15,1",  # 15" 2018 - Intel + AMD Polaris
    "MacBookPro15,3",  # 15" 2019 - Intel + AMD Vega
    "MacBookPro16,1",  # 16" 2019 - Intel + AMD Navi
    "MacBookPro16,4",  # 16" 2019 - Intel + AMD Navi (alternate config)
    "Macmini5,2",
    "iMac12,1",
    "iMac12,2",
    "iMac13,1",
