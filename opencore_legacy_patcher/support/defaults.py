        ...
        if spoof_model in smbios_data.smbios_dictionary:
            if smbios_data.smbios_dictionary[spoof_model]["SecureBootModel"] is not None:
                if self.constants.sip_status is False:
                    ...
                    # Models with Intel UHD 630 and T2 chips can hang at Apple Logo if VMM CPUID is enabled.
                    # Disabling VMM for these models allows the UHD 630 driver to load natively.
